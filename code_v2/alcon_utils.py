...
class AlconUtils(object):
    ...
    def load_annotations_target(self, fn ):
        ...
        """
        target_file = os.path.join(self.datasetdir, "annotations","train_lv1", fn)
    ...
    def load_annotations_ground(self, fn ):
        ...
        """
        gt_file = os.path.join(self.datasetdir, "annotations","train_lv1", fn)
    ...
    def get_filename_char(self, bb_id):
        ...
        #print(ground)
        #print(target)
        fn =  ground + "_" + target[0] + \
              "_X" + '{0:04d}'.format(target[1]) + \
              "_Y" + '{0:04d}'.format(target[2]) + ".jpg"
        fn = os.path.join(self.datasetdir, "characters", ground, fn)
        return fn
